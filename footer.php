  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-12">
        <h4 class="font-rubik font-size-20">BooksHaven PH</h4>
        <p class="font-size-14 font-raleway text-white-50">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse a quam pulvinar, imperdiet risus quis, pharetra dolor. Duis nec erat diam. Maecenas metus purus, imperdiet sit amet urna non</p>
      </div>
      ...
      <div class="col-lg-2 col-12">
        ...
        <div class="d-flex flex-column flex-wrap">
          ...
          <a href="#" class="font-raleway font-size-14 text-white-50 pb-1">Terms and Conditions</a>
...
<div class="copyright text-center bg-dark text-white py-2">
  <p class="font-raleway font-size-14">&copy; Copyrights 2020. Designed By <a href="#" class="color-secondary">kathryn</p>
</div>
